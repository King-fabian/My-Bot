...
try {
    ...
    console.log("🌍 Connected to the Flash Multidevice");
} catch {
...
let cc = Config.sessionName.replace(/FLASH-MD-WA-BOT;;;=>/g, "").replace(/BLACK;;;/gi, ""); // DONT REMOVE BLACK;;; so you can connect BLACK md session id too
